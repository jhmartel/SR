...
% Our purpose here is to describe a positive gap in above mentioned proof, and to further demonstrate the untenability of its conclusions. The gap is described by two errors, described below. This is a controversial subject developed by other critical authors, e.g. \cite{bryant}, \cite{crothers}. The present note arises from the author's own study of the controversy, and his attempt to identify the error in plain mathematical terms. 
